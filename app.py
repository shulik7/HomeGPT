...
def form_post():
    ...
    if request.method == 'POST':
        ...
        output = error_message if response is None else response.choices[0].message["content"]
        ...
        return render_template('home.html', history=session['history'], model=session.get('model', 'gpt-3.5-turbo'), 
